...
from .views import RideCreateView,RideDetailView,RideListView,RideStatusUpdateView,DriverRideAcceptView
...
urlpatterns =[
    ...
    path('rides/<int:ride_id>/accept/', DriverRideAcceptView.as_view(), name='driver-ride-accept'),
